...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/cards/{region}/batch": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Comma-separated card IDs (up to 100)",
                        "name": "ids",
                        "in": "query",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/shared.CardBatchItemsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/character3ds/{region}/batch": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Comma-separated Character3D IDs (up to 100)",
                        "name": "ids",
                        "in": "query",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/shared.Character3DBatchResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/unitStoryEpisodeGroups/{region}/list": {
            "get": {
                "produces": [
                    "application/json"
                ],
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/shared.WorldBloomListResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "shared.CardBatchItemsResponse": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/shared.CardBatchItemResponse"
                    }
                }
            }
        },
        ...
        "shared.Character3DBatchResponse": {
            "type": "object",
            "required": [
                "items",
                "missingIds"
            ...
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/shared.Character3DBatchItem"
                    }
                },
                "missingIds": {
                    "type": "array",
        ...
        "shared.GenericRecordListResponse": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
